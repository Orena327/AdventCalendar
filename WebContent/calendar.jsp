...
<body>
	<div class="main">
		...
		<p class="">Adventní kalendář každý den nový recept přináší, na
			tvoji tváří úsměv rozzáří. Tak jako u čokoládové verze, otevři každý
			den jeden, připrav si tak dobroty nejlépe předem. Seřazeny jsou, aby
			ti vydrželi, až do Vánočního dne. Tak neváhej a pusť se do toho
			rovnou hned.</p>
		<div class="container2">
			<form action="ActionServlet" method="post" class="container">
				...
				%>
				<div class="box">
					<button class="star" type="submit" name="action" id="day<%=i + 1%>"
						value="day<%=i + 1%>">
